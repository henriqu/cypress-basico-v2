...
beforeEach(function(){
  Cypress.THREE_SECONDS_IN_MS = 3000
...
describe('Central de Atendimento ao Cliente TAT', function() {
  ...
  it('preenche os campos obrigatórios e envia o formulário', function() {
    ...
    cy.get('#email').type('victorhenrique38@outlook.com')
    cy.get('#open-text-area').type(longTest, {delay: 0})
    cy.contains('button', 'Enviar').click()

    cy.get('.success > strong').should('be.visible')

    cy.tick(Cypress.THREE_SECONDS_IN_MS)
  ...
  it('validar que, se um valor não-numérico for digitado, seu valor continuará vazio', function() {
    cy.get('#phone').type('abcdefgjijd').should('have.value', '')
  });
  ...
  it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
    ...
    cy.get('#email').type('victorhenrique38@outlook.com').should('have.value', 'victorhenrique38@outlook.com').clear().should('have.value', '')
